...
pub fn handler(tokens: &mut Vec<Snowflake>, mut pos: usize, final_file: &mut Vec<String>) -> usize {
    ...
    match value_token.value_type {
        ...
        Types::I8 => final_file.push(format!("let {name}: i8 = {};", value_token.value)),
        Types::I16 => final_file.push(format!("let {name}: i16 = {};", value_token.value)),
        Types::I32 => final_file.push(format!("let {name}: i32 = {};", value_token.value)),
        _ => (),
    }
    pos
}
